...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModel = ViewModelProvider(this).get(ModelView::class.java)
        ...
        zero.setOnClickListener {
            viewModel.setNum('0'); display.text = viewModel.displayText
        }
        one = findViewById(R.id.bt1)
        one.setOnClickListener {
            viewModel.setNum('1'); display.text = viewModel.displayText
        }
        two = findViewById(R.id.bt2)
        two.setOnClickListener {
            viewModel.setNum('2'); display.text = viewModel.displayText
        }
        three = findViewById(R.id.bt3)
        three.setOnClickListener {
            viewModel.setNum('3'); display.text = viewModel.displayText
        }
        four = findViewById(R.id.bt4)
        four.setOnClickListener {
            viewModel.setNum('4'); display.text = viewModel.displayText
        }
        five = findViewById(R.id.bt5)
        five.setOnClickListener {
            viewModel.setNum('5'); display.text = viewModel.displayText
        }
        six = findViewById(R.id.bt6)
        six.setOnClickListener {
            viewModel.setNum('6'); display.text = viewModel.displayText
        }
        seven = findViewById(R.id.bt7)
        seven.setOnClickListener {
            viewModel.setNum('7'); display.text = viewModel.displayText
        }
        eight = findViewById(R.id.bt8)
        eight.setOnClickListener {
            viewModel.setNum('8'); display.text = viewModel.displayText
        }
        nine = findViewById(R.id.bt9)
        nine.setOnClickListener {
            viewModel.setNum('9'); display.text = viewModel.displayText
        }
        ...
        clear.setOnClickListener {
            viewModel.clearAll(); display.text = viewModel.displayText
        }
        result = findViewById(R.id.btEquals)
        result.setOnClickListener {
            viewModel.calculate(); display.text = viewModel.displayText
        }
        del = findViewById(R.id.btDel)
        del.setOnClickListener {
            viewModel.deleteLast(); display.text = viewModel.displayText
        }
    }
